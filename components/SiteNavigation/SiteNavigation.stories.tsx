...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "The default SiteNavigation with common site links including Home, Blog, About, and Contact.",
      },
    },
  },
};
...
export const WithExternalLinks: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Navigation including external links that open in new tabs with proper security attributes.",
      },
    },
  },
  args: {
...
export const ExtensiveNavigation: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Navigation with many items to demonstrate how it handles larger menus.",
      },
    },
  },
  args: {
...
export const CategoryNavigation: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Navigation focused on content categories, useful for blogs or documentation sites.",
      },
    },
  },
  args: {
...
export const Playground: Story = {
  parameters: {
    docs: {
      description: {
        story:
          "Interactive playground to experiment with SiteNavigation props and see real-time changes.",
      },
    },
  },
};
