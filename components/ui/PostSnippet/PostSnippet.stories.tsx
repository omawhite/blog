      ...
      <div>
        ...
        <div className="space-y-4">
          <PostSnippet
            size="sm"
            variant="default"
            title="Small Default Post"
            description="This is a small post with default border styling."
            publishedAt="2024-01-10T08:00:00Z"
            href="/blog/small-default"
          />
          <PostSnippet
            size="default"
            variant="default"
            title="Regular Default Post"
            description="This is a regular sized post with default border styling."
            publishedAt="2024-01-11T08:00:00Z"
            href="/blog/regular-default"
          />
          <PostSnippet
            size="lg"
            variant="default"
            title="Large Default Post"
            description="This is a large post with default border styling."
            publishedAt="2024-01-12T08:00:00Z"
            href="/blog/large-default"
          />
        </div>
      </div>
      <div>
        ...
        <div className="space-y-4">
          <PostSnippet
            size="sm"
            variant="ghost"
            title="Small Ghost Post"
            description="This is a small post with ghost styling (no border)."
            publishedAt="2024-01-10T08:00:00Z"
            href="/blog/small-ghost"
          />
          <PostSnippet
            size="default"
            variant="ghost"
            title="Regular Ghost Post"
            description="This is a regular sized post with ghost styling (no border)."
            publishedAt="2024-01-11T08:00:00Z"
            href="/blog/regular-ghost"
          />
          <PostSnippet
            size="lg"
            variant="ghost"
            title="Large Ghost Post"
            description="This is a large post with ghost styling (no border)."
            publishedAt="2024-01-12T08:00:00Z"
            href="/blog/large-ghost"
          />
        </div>
      </div>
    </div>
    ...
    <div className="max-w-4xl">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <PostSnippet
          ...
          description="Learn how to create, document, and maintain a robust component library using Storybook and modern development tools."
          publishedAt="2024-01-28T10:00:00Z"
          href="/blog/component-library-storybook"
          variant="default"
        />
        <PostSnippet
          title="Mastering CSS Grid for Complex Layouts"
          description="Advanced CSS Grid techniques for creating responsive and maintainable layouts in modern web applications."
          publishedAt="2024-01-25T14:30:00Z"
          href="/blog/css-grid-layouts"
          variant="default"
        />
        <PostSnippet
          title="TypeScript Tips for Better Developer Experience"
          description="Practical TypeScript patterns and techniques that improve code quality and developer productivity."
          publishedAt="2024-01-22T09:15:00Z"
          href="/blog/typescript-developer-experience"
          variant="default"
        />
        <PostSnippet
          title="Performance Optimization in React Applications"
          description="Essential strategies for optimizing React app performance, from code splitting to efficient state management."
          publishedAt="2024-01-18T16:45:00Z"
          href="/blog/react-performance-optimization"
          variant="default"
        />
        <PostSnippet
          title="Design System Tokens: A Practical Guide"
          description="How to implement and manage design tokens for consistent theming across your design system."
          publishedAt="2024-01-15T11:20:00Z"
          href="/blog/design-system-tokens"
          variant="default"
        />
        <PostSnippet
          title="Modern CSS: New Features You Should Know"
          description="Explore the latest CSS features that are changing how we style web applications."
          publishedAt="2024-01-12T13:00:00Z"
          href="/blog/modern-css-features"
          variant="default"
        />
      </div>
    </div>
